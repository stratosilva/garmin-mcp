...
def demo_html():
    ...
    html = PAGE_HTML.replace('<title>Training Dashboard</title>', '<title>CONNECT. ANALYZE. ADVISE · Manuel Silva Gallego</title><meta name="description" content="An interactive AI strategy and data integration case study by Manuel Silva Gallego. Garmin, Basic-Fit and injury context, brought together in a working dashboard.">')
    html = html.replace('</head>', '<meta property="og:title" content="CONNECT. ANALYZE. ADVISE · Manuel Silva Gallego"><meta property="og:description" content="A two-minute interactive tour: Garmin, Basic-Fit and injury context turned into actionable training decisions. Built with ChatGPT."><meta property="og:type" content="website"><style>'+css+'</style></head>')
