...
(function(){
  ...
  const sampleAdvice='ILLUSTRATIVE AI ADVICE · FICTIONAL SCENARIO\n\nCARDIO — Choose an easy 20–30 minute walk or gentle ride today. Sleep was shorter than usual, and the knee still deserves attention. Stop if movement aggravates it.\n\nSTRENGTH — Upper body & core · about 45–50 minutes\nToday’s aim: controlled technique and moderate effort, with seated or supported exercises to limit time on your feet. These are illustrative starting loads for Miles; adjust them to leave about 3 good reps in reserve.\n\nWarm-up: 5 minutes of gentle upper-body mobility, then a light practice set of presses and rows.\n\n1. Dumbbell bench press — 3 × 10 reps · 12 kg per hand · rest 90 seconds.\nKeep feet comfortable and avoid forceful leg drive.\n2. Seated cable row — 3 × 12 reps · 25 kg on the stack · rest 75 seconds.\nKeep your torso still; draw elbows back without jerking.\n3. Lat pulldown — 3 × 10 reps · 25 kg on the stack · rest 75 seconds.\nPull towards your upper chest; return slowly.\n4. Seated dumbbell lateral raise — 3 × 12 reps · 4 kg per hand · rest 60 seconds.\nUse a comfortable range and avoid shrugging.\n5. Seated dumbbell curl — 3 × 12 reps · 6 kg per hand · rest 60 seconds.\nKeep elbows still and lower the weights under control.\n6. Dead bug — 3 × 8 reps per side · bodyweight, 0 kg added · rest 45 seconds.\nMove slowly and keep your lower back comfortably supported.\n\nCoaching check: 18 working sets, no sets to failure. Reduce the load if technique changes or fewer than 3 reps remain in reserve. Stop any exercise that increases knee or foot pain. Log the actual loads, reps and next-day symptoms before progressing.\n\nRECOVERY — Give yourself a longer sleep window tonight. Record tomorrow’s pain score and how the session felt before increasing intensity. Persistent or worsening symptoms deserve professional assessment.\n\nWHY — This example brings together sleep, training load, muscle exposure and the athlete’s own injury report. The public demo displays prepared advice; the personal product requests AI advice from its current data.';
